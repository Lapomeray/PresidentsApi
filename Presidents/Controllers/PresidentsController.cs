...
namespace Presidents.Controllers
{
    ...
    public class PresidentsController : Controller
    {
        ...
        public List<President> List()
        {
            ...
            return (System.Collections.Generic.List<Presidents.Models.President>)presidentList;
        }
        ...
        {
            return List().OrderBy(value => value.Name);
        }
        ...
        {
            return List().OrderByDescending(value => value.Name);
        }
